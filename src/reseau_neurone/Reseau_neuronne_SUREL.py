...
def main():
    ...
    dataset = pd.read_csv('Creation_Data/Data.csv')
    ...
    dataset1 = pd.read_csv('Creation_Data/Data.csv', header = nb_dataset_train)
    dataset2 = pd.read_csv('Creation_Data/Data.csv', header = nb_dataset_test)
